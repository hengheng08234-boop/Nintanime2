export const appText = {
  en: {
    ...
    subTimeoutDesc:
      "We didn't receive a confirmation in 30 seconds. If you already paid, tap below to start a new session — your previous payment is still being watched.",
  ...
  km: {
    ...
    subTimeoutDesc:
      'យើងមិនទទួលបានការបញ្ជាក់ក្នុង ៣០ វិនាទីទេ។ បើអ្នកបានទូទាត់ហើយ សូមចុចខាងក្រោមដើម្បីចាប់ផ្ដើមសម័យថ្មី — ការទូទាត់មុននៅតែត្រូវបានតាមដាន។',
